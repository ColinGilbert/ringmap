...
%\end{large}
\begin{itemize}
	\item Hardware: The following \emph{Intel GbE Controllers}
		\begin{itemize}
...
%	\begin{itemize}
%		\item <6->due to the \emph{read}-Syscall
%		\item <6->BPF-Buffer $\Rightarrow$ 	User-Buffer
%	\end{itemize}
...
\begin{itemize}
	...
	\item Based on \textbf{generic}-Stack: 		
		\begin{itemize}
			\item based on generic network drivers (\emph{em}, \emph{igb}, \emph{ixgbe}) and \emph{libpcap}
			\begin{itemize}
