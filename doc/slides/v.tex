...
\end{itemize}
\begin{small}
	\item [$\Rightarrow$] Die Capturing-Software f"ur FreeBSD wurde in der Zeit entwickelt, 
		als die Bit-Raten in Netzen noch sehr niedrig waren und keine Probleme beim Capturing 
		verursacht haben.
\end{small}
\end{itemize}
\end{frame}
