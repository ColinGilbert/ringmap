...
wird dabei analysiert bei welchen Capturing-Software-Komponenten unter welchen Umständen
...
Capturing-Software formuliert (siehe Kapitel \ref{sec:anf_for_entwurf}).  Zu beachten ist, dass die dargestellten Aspekte
...
\end{figure}
%
\subsubsection{Netzwerkl-Treiber: Interruptbehandlung}\label{sec:intr_behandlung}
...
%
\subsubsection{Berkley Packet Filter (BPF)}\label{sec:bpf}
...
\newpage
\ifthenelse{\boolean{BRIEF}}{
\section{Anforderungen für den neuen ringmap Capturing-Stack}\label{sec:anf_for_entwurf}
}{
